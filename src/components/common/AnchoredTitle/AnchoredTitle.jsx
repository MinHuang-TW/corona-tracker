...
export const AnchoredTitle = ({ hrefId, classes, color = 'rgba(255, 255, 255, 0.87)', children }) => (
  <a href={`#${hrefId}`} className={cx(classes, styles.title)} style={{ color, marginBottom: 24 }}>
    <Anchor color={color} />
    <h1>{children}</h1>
  </a>
);
